...
{
    /// <inheritdoc />
    public partial class addedfucktonofclasses : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserProfile_FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserProfile_LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserProfile_DateOfBirth = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserProfile_PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserProfile_Bio = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialLinks_Website = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialLinks_Instagram = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialLinks_Twitter = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateOnly>(type: "date", nullable: false),
                    NationalityId = table.Column<int>(type: "int", nullable: false),
                    Biography_ShortBio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Biography_FullBio = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_Street = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_State = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_PostalCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Authors_Educations_EducationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Awards_Artists_ArtistId",
                        column: x => x.ArtistId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistCover", x => new { x.ArtistId, x.CoverId });
                    table.ForeignKey(
